# 👨‍💻 **Sadam Barkat**  
### **Full-Stack Web Developer | Agentic AI Developer | Database Engineer**

---

## 🚀 **About Me**
Passionate Software Engineer specializing in **Full-Stack Web Development**, **Agentic AI Systems**, and **Database Engineering**. I enjoy building scalable applications using modern tools like **Next.js, React, Node.js, LangChain, LangGraph, OpenAI Agent SDK**, and **cloud-native architectures**.  
I actively solve DSA problems to improve my logic and contribute to real-world AI and automation projects.
...
| **50_SQL_LeetCode_Problems**              | A collection of SQL solutions to LeetCode problems | [50_SQL_LeetCode_Problems](https://github.com/Sadam-Barkat/50_SQL_LeetCode_Problems) |
| **Cloud-Native-Agentic-AI**           | Projects related to cloud-native agentic AI        | [Cloud-Native-Agentic-AI](https://github.com/Sadam-Barkat/Cloud-Native-Agentic-AI) |
| **Data_Structures_And_Algorithms**| DSA learning & practice repository | [Data_Structures_And_Algorithms](https://github.com/Sadam-Barkat/Data_Structures_And_Algorithms) |
| **Python_For_DataAnalysis**      | Python scripts for practice & learning | [Python_For_DataAnalysis](https://github.com/Sadam-Barkat/Python_For_DataAnalysis) |

---

# 🙌 **Thanks for Visiting!**
Feel free to connect or collaborate — always happy to learn and build amazing things together. 🚀
